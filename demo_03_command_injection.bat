@echo off
REM =============================================================================
REM  demo_03_command_injection.bat - Kich ban 3: Command Injection
REM =============================================================================
...
echo ============================================================
echo  [3/10] KICH BAN: OS Command Injection (CWE-78)
echo ============================================================
echo.

set FILE_AUTH=auth.c
set FILE_VULN=vulnerable\03_command_injection.c
set FILE_SAFE=safe\03_command_injection.c
set MSG_VULN=add command injection - shell command from user input
set MSG_SAFE=fix command injection - whitelist validation, no shell
...
echo ============================================================
echo  HOAN THANH KICH BAN 3: Command Injection
echo ============================================================
pause
