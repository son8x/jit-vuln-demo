...
chcp 65001 >nul
REM =============================================================================
REM  scripts/demo_10_integer_overflow.bat - Demo kich ban 10: Integer Overflow
REM =============================================================================
REM  Kich ban nay minh hoa:
REM    - Loi Integer Overflow (CWE-190)
...
REM    cd github_demo
REM    scripts\demo_10_integer_overflow.bat
REM =============================================================================
...
REM ===== CAU HINH =====
set SO_KICH_BAN=10
set TEN_KICH_BAN=Integer Overflow (CWE-190)
set CWE=CWE-190
set XEP_HANG=Tier 2 (dat trung C/C++)
set CVE_LIEN_QUAN=CVE-2018-6789 (Exim)
...
set FILE_VULN=%REPO_ROOT%\scenarios\10\int_overflow_vuln.c
set FILE_SAFE=%REPO_ROOT%\scenarios\10\int_overflow_safe.c
...
echo.
echo [1.1] Copy file co loi: scenarios\10\int_overflow_vuln.c -^> auth.c
...
echo.
echo [1.4] git commit -m "add integer_overflow vulnerability"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "add integer_overflow vulnerability" 2>&1
set RC=%errorlevel%
echo.
if %RC% neq 0 (
    echo +================================================================+
...
echo.
echo [2.1] Copy file an toan: scenarios\10\int_overflow_safe.c -^> auth.c
...
git add "%REPO_ROOT%\auth.c" 2>nul
echo.
echo [2.3] git commit -m "fix integer_overflow - use safe pattern"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "fix integer_overflow - use safe pattern" 2>&1
set RC=%errorlevel%
echo.
if %RC% equ 0 (
    echo +================================================================+
