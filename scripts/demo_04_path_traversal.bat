...
chcp 65001 >nul
REM =============================================================================
REM  scripts/demo_04_path_traversal.bat - Demo kich ban 4: Path Traversal
REM =============================================================================
REM  Kich ban nay minh hoa:
REM    - Loi Path Traversal (CWE-22)
...
REM    cd github_demo
REM    scripts\demo_04_path_traversal.bat
REM =============================================================================
...
REM ===== CAU HINH =====
set SO_KICH_BAN=4
set TEN_KICH_BAN=Path Traversal (CWE-22)
set CWE=CWE-22
set XEP_HANG=Tier 2 (web app)
set CVE_LIEN_QUAN=CVE-2021-41773 (Apache)
...
set FILE_VULN=%REPO_ROOT%\scenarios\04\path_vuln.c
set FILE_SAFE=%REPO_ROOT%\scenarios\04\path_safe.c
...
echo.
echo [1.1] Copy file co loi: scenarios\04\path_vuln.c -^> auth.c
...
echo.
echo [1.4] git commit -m "add path_traversal vulnerability"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "add path_traversal vulnerability" 2>&1
set RC=%errorlevel%
echo.
if %RC% neq 0 (
    echo +================================================================+
...
echo.
echo [2.1] Copy file an toan: scenarios\04\path_safe.c -^> auth.c
...
git add "%REPO_ROOT%\auth.c" 2>nul
echo.
echo [2.3] git commit -m "fix path_traversal - use safe pattern"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "fix path_traversal - use safe pattern" 2>&1
set RC=%errorlevel%
echo.
if %RC% equ 0 (
    echo +================================================================+
