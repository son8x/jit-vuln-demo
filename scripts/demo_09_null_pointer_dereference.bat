...
chcp 65001 >nul
REM =============================================================================
REM  scripts/demo_09_null_pointer_dereference.bat - Demo kich ban 9: NULL Pointer Dereference
REM =============================================================================
REM  Kich ban nay minh hoa:
REM    - Loi NULL Pointer Dereference (CWE-476)
...
REM    cd github_demo
REM    scripts\demo_09_null_pointer_dereference.bat
REM =============================================================================
...
REM ===== CAU HINH =====
set SO_KICH_BAN=9
set TEN_KICH_BAN=NULL Pointer Dereference (CWE-476)
set CWE=CWE-476
set XEP_HANG=#9 CWE Top 25
set CVE_LIEN_QUAN=CVE-2021-30860 (iOS)
...
set FILE_VULN=%REPO_ROOT%\scenarios\09\null_deref_vuln.c
set FILE_SAFE=%REPO_ROOT%\scenarios\09\null_deref_safe.c
...
echo.
echo [1.1] Copy file co loi: scenarios\09\null_deref_vuln.c -^> auth.c
...
echo.
echo [1.4] git commit -m "add null_pointer_dereference vulnerability"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "add null_pointer_dereference vulnerability" 2>&1
set RC=%errorlevel%
echo.
if %RC% neq 0 (
    echo +================================================================+
...
echo.
echo [2.1] Copy file an toan: scenarios\09\null_deref_safe.c -^> auth.c
...
git add "%REPO_ROOT%\auth.c" 2>nul
echo.
echo [2.3] git commit -m "fix null_pointer_dereference - use safe pattern"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "fix null_pointer_dereference - use safe pattern" 2>&1
set RC=%errorlevel%
echo.
if %RC% equ 0 (
    echo +================================================================+
