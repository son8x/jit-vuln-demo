...
chcp 65001 >nul
REM =============================================================================
REM  scripts/demo_03_command_injection.bat - Demo kich ban 3: Command Injection
REM =============================================================================
REM  Kich ban nay minh hoa:
REM    - Loi Command Injection (CWE-78)
...
REM    cd github_demo
REM    scripts\demo_03_command_injection.bat
REM =============================================================================
...
REM ===== CAU HINH =====
set SO_KICH_BAN=3
set TEN_KICH_BAN=Command Injection (CWE-78)
set CWE=CWE-78
set XEP_HANG=Tier 1 (web app)
set CVE_LIEN_QUAN=CVE-2021-3156 (Sudo)
...
set FILE_VULN=%REPO_ROOT%\scenarios\03\cmd_vuln.c
set FILE_SAFE=%REPO_ROOT%\scenarios\03\cmd_safe.c
...
echo.
echo [1.1] Copy file co loi: scenarios\03\cmd_vuln.c -^> auth.c
...
echo.
echo [1.4] git commit -m "add command_injection vulnerability"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "add command_injection vulnerability" 2>&1
set RC=%errorlevel%
echo.
if %RC% neq 0 (
    echo +================================================================+
...
echo.
echo [2.1] Copy file an toan: scenarios\03\cmd_safe.c -^> auth.c
...
git add "%REPO_ROOT%\auth.c" 2>nul
echo.
echo [2.3] git commit -m "fix command_injection - use safe pattern"
echo       (Hook se tu dong chay SCGL de phan tich...)
git commit -m "fix command_injection - use safe pattern" 2>&1
set RC=%errorlevel%
echo.
if %RC% equ 0 (
    echo +================================================================+
