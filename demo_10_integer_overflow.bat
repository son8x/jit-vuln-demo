@echo off
REM =============================================================================
REM  demo_10_integer_overflow.bat - Kich ban 10: Integer Overflow
REM =============================================================================
...
echo ============================================================
echo  [10/10] KICH BAN: Integer Overflow (CWE-190)
echo ============================================================
echo.

set FILE_AUTH=auth.c
set FILE_VULN=vulnerable\10_integer_overflow.c
set FILE_SAFE=safe\10_integer_overflow.c
set MSG_VULN=add integer overflow - no check before multiplication
set MSG_SAFE=fix integer overflow - check overflow before multiplication
...
echo ============================================================
echo  HOAN THANH KICH BAN 10: Integer Overflow
echo ============================================================
echo.
echo ============================================================
echo  TAT CA 10 KICH BAN DA HOAN THANH!
echo ============================================================
pause
